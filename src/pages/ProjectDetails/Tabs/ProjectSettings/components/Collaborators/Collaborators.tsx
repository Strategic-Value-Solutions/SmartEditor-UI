...
const Collaborators = () => {
  ...
  const handleInviteCollaboratorModal = () => {
    setOpenInviteCollaboratorModal(!openInviteCollaboratorModal)
  }
    ...
    <div className='bg-white dark:bg-gray-800  rounded-lg'>
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4'>
        ...
        <AddCollaboratorDialog
          ...
          handleInviteCollaboratorModal={handleInviteCollaboratorModal}
        />
      </div>
          ...
          >
            ...
            <div className='text-gray-500 dark:text-gray-400 text-sm'>
              {collaborator?.role?.charAt(0).toUpperCase() +
                collaborator?.role?.slice(1).toLowerCase()}
            </div>
